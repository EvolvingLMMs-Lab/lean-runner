...
from . import prove_pb2 as prove__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in prove_pb2_grpc.py depends on'
...
def add_ProveServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('lean_runner.ProveService', rpc_method_handlers)
